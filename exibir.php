...
?> 
  ...
  <div style="padding-bottom:10%; position:relative; display:block; width: 100%; height: 500px;">
<iframe class="embed-responsive-item" width="100%" height="100%" allowfullscreen="" src="<?php echo $convertedURL; ?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" all>
</div>
